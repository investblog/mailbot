...
const EN: Dict = {
  ...
  rateUs: 'Rate us',
  cancel: 'Cancel',
  newConfirmTitle: 'New address?',
  newConfirmBody: 'The current address and the codes received to it will no longer be shown:',
...
const RU: Dict = {
  ...
  rateUs: 'Оценить',
  cancel: 'Отмена',
  newConfirmTitle: 'Новый адрес?',
  newConfirmBody: 'Текущий адрес и полученные на него коды перестанут показываться:',
